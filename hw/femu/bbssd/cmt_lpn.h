...
uint64_t trnsl_page_write(struct ssd *ssd, uint64_t mvpn, uint64_t stime);
void cmt_append(struct ssd *ssd, uint64_t lpn);
bool cmt_find(struct ssd *ssd, uint64_t lpn);
uint64_t cmt_evict(struct ssd *ssd, uint64_t stime);
void cmt_dirty(struct ssd *ssd, uint64_t lpn);
uint64_t cmt_oper(struct ssd *ssd, uint64_t lpn, uint64_t stime);
